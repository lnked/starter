    ...
    if (propsValue.isPartialObject()) {
      ...
      if (propsValue.properties.has("children")) {
        ...
        if (childrenValue !== realm.intrinsics.undefined && childrenValue !== realm.intrinsics.null) {
          if (childrenValue instanceof _index.ArrayValue && !childrenValue.intrinsicName) {
            ...
            if (childrenLength instanceof _index.NumberValue) {
              ...
              for (let i = 0; i < childrenLengthValue; i++) {
                ...
                (0, _invariant2.default)(child instanceof _index.Value, `ReactElement "props.children[${i}]" failed to visit due to a non-value`);
