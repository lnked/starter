    ...
    if (stateToUpdate instanceof _index.ObjectValue) {
      ...
      for (let [key, binding] of stateToUpdate.properties) {
        if (binding && binding.descriptor && binding.descriptor.enumerable) {
          ...
          _singletons.Properties.Set(realm, newState, key, value, true);
        }
      }
  ...
  const deriveState = state => {
    ...
    if (state instanceof _index.AbstractValue && !(state instanceof _index.AbstractObjectValue)) {
      ...
      if (kind === "conditional") {
        ...
        _index.AbstractValue.createTemporalFromBuildFunction(realm, _index.FunctionValue, [objectAssign, newState, prevState, state], ([methodNode, ..._args]) => {
