...
exports.default = function (ast, strictCode, env, realm) {
  ...
  let joinedEffects = _singletons.Join.joinEffects(realm, exprValue, new _realm.Effects(ce.result, ce.generator, ce.modifiedBindings, ce.modifiedProperties, ce.createdObjects), new _realm.Effects(ae.result, ae.generator, ae.modifiedBindings, ae.modifiedProperties, ae.createdObjects));
