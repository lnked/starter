  ...
  if (switchValue instanceof _index.AbstractValue && !switchValue.values.isTop()) {
    ...
    if (n > 1 && n < 10) {
      ...
      for (let concreteSwitchValue of elems) {
        let condition = _index.AbstractValue.createFromBinaryOp(realm, "===", switchValue, concreteSwitchValue);
        ...
        }, undefined, "specialized switch");
        joinedEffects = joinedEffects === undefined ? effects : _singletons.Join.joinEffects(realm, condition, effects, joinedEffects);
      }
      ...
      (0, _invariant2.default)(result instanceof _index.Value); // since evaluationHelper returns a value in non abrupt cases
      return result;
    }
  }
