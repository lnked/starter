...
exports.default = function (ast, strictCode, env, realm) {
  ...
  if (ref instanceof _environment.Reference && ref.base instanceof _index2.AbstractValue && ref.base.mightNotBeObject() && realm.isInPureScope()) {
    let dummy = ref.base;
    ...
    return realm.evaluateWithPossibleThrowCompletion(() => generateRuntimeCall(ref, dummy, ast, strictCode, env, realm), _index.TypesDomain.topVal, _index.ValuesDomain.topVal);
  }
...
function callBothFunctionsAndJoinTheirEffects(args, ast, strictCode, env, realm) {
  ...
  let joinedEffects = _singletons.Join.joinEffects(realm, cond, new _realm.Effects(e1.result, e1.generator, e1.modifiedBindings, e1.modifiedProperties, e1.createdObjects), new _realm.Effects(e2.result, e2.generator, e2.modifiedBindings, e2.modifiedProperties, e2.createdObjects));
