...
exports.default = function (ast, strictCode, env, realm) {
  ...
  for (let node of ast.body) {
    if (node.type !== "FunctionDeclaration") {
      ...
      if (res instanceof _completions.AbruptCompletion) {
        ...
        if (res instanceof _completions.JoinedAbruptCompletions && res.containsCompletion(_completions.ThrowCompletion)) {
  ...
  if (val instanceof _index.Value) {
    ...
    if (res instanceof _completions.PossiblyNormalCompletion) {
      ...
      let effectsTree = _singletons.Join.joinPossiblyNormalCompletionWithAbruptCompletion(realm, res, new _completions.ReturnCompletion(realm.intrinsics.undefined), e);
      realm.applyEffects(effectsTree, "", false);
      // The global state is now at the point where the first fork occurred.
      res = effectsTree.result;
      (0, _invariant2.default)(res instanceof _completions.JoinedAbruptCompletions);
      let generator = realm.generator;
      (0, _invariant2.default)(generator !== undefined);
