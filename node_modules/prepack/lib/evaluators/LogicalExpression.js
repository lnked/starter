...
exports.default = function (ast, strictCode, env, realm) {
  ...
  (0, _invariant2.default)(lcond instanceof _index.AbstractValue);
  ...
  let joinedEffects;
  if (ast.operator === "&&") {
    joinedEffects = _singletons.Join.joinEffects(realm, lval, new _realm.Effects(result2, generator2, modifiedBindings2, modifiedProperties2, createdObjects2), new _realm.Effects(lval, generator1, modifiedBindings1, modifiedProperties1, createdObjects1));
  } else {
    joinedEffects = _singletons.Join.joinEffects(realm, lval, new _realm.Effects(lval, generator1, modifiedBindings1, modifiedProperties1, createdObjects1), new _realm.Effects(result2, generator2, modifiedBindings2, modifiedProperties2, createdObjects2));
  }
  ...
  if (lval instanceof _index.Value && result2 instanceof _index.Value) {
    ...
    completion = _index.AbstractValue.createFromLogicalOp(realm, ast.operator, lval, result2, ast.loc);
  }
  return completion;
};
