...
class Referentializer {
  constructor(realm, options, scopeNameGenerator, scopeBindingNameGenerator) {
  ...
  createCaptureScopeAccessFunction(referentializationScope) {
    ...
    for (const scopeBinding of serializedScopes.values()) {
      ...
      const key = (0, _babelGenerator2.default)(expr, {}, "").code;
  ...
  _getSerializedBindingScopeInstance(residualBinding) {
    ...
    (0, _invariant2.default)(scope.referentializationScope === referentializationScope);
  ...
  referentializeBinding(residualBinding) {
