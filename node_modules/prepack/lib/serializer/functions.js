...
class Functions {
  ...
  __optimizedFunctionEntryOfValue(value) {
    ...
    realm.handleError(new _errors.CompilerDiagnostic(`Optimized Function Value ${location} is an not a function or react element`, undefined, "PP0033", "FatalError"));
  ...
  optimizeReactComponentTreeRoots(statistics, reactSerializerState, environmentRecordIdAfterGlobalCode) {
    ...
    for (let _ref of recordedReactRootValues) {
      ...
      (0, _optimizing.optimizeReactComponentTreeRoot)(this.realm, componentRoot, config, this.writeEffects, environmentRecordIdAfterGlobalCode, logger, statistics, reactSerializerState);
    }
