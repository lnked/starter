...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("concat", 1, (context, args, argCount) => {
    ...
    if (_index.ArrayValue.isIntrinsicAndHasWidenedNumericProperty(O)) {
      let newArgs = [O, ...args];
  ...
  obj.defineNativeMethod("map", 1, (context, [callbackfn, thisArg]) => {
    ...
    if (_index.ArrayValue.isIntrinsicAndHasWidenedNumericProperty(O) && O.isSimpleObject()) {
      let args = [O, callbackfn];
      if (thisArg) {
        args.push(thisArg);
      }
    ...
    let A = _singletons.Create.ArraySpeciesCreate(realm, O.throwIfNotConcreteObject(), len);
