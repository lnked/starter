  ...
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION) && !realm.isCompatibleWith("mobile")) {
    let ObjectAssign = func.defineNativeMethod("assign", 2, (context, [target, ...sources]) => {
      ...
      for (let nextSource of sources) {
        ...
        if ((0, _index3.HasSomeCompatibleType)(nextSource, _index2.NullValue, _index2.UndefinedValue)) continue;
      ...
      if (to_must_be_partial) {
        ...
        let temporalTo = _index2.AbstractValue.createTemporalFromBuildFunction(realm, _index2.ObjectValue, [ObjectAssign, to, ...delayedSources], ([methodNode, targetNode, ...sourceNodes]) => {
        ...
        if (to instanceof _index2.AbstractObjectValue) {
          temporalTo.values = to.values;
        } else {
          (0, _invariant2.default)(to instanceof _index2.ObjectValue);
          temporalTo.values = new _index.ValuesDomain(to);
        }
