...
function createStatistics(options) {
  ...
  return options.profile ? new _statistics.SerializerStatistics(() => Date.now(), () => {
    if (gc) gc();
...
function prepackFileSync(filenames, options = _options.defaultOptions) {
  ...
  return (0, _prepackStandalone2.prepackSources)(sourceFiles, options, debugChannel, createStatistics(options));
}
