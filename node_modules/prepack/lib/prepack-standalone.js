...
function prepackSources(sources, options = _options.defaultOptions, debugChannel = undefined, statistics = undefined) {
  let realmOptions = (0, _prepackOptions.getRealmOptions)(options);
  realmOptions.errorHandler = options.errorHandler;
  let realm = (0, _construct_realm2.default)(realmOptions, debugChannel, statistics || new _statistics.SerializerStatistics());
