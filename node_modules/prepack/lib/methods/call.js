        ...
        try {
          ...
          if (!(c instanceof _completions.ReturnCompletion)) {
            if (!(c instanceof _completions.AbruptCompletion)) {
              c = new _completions.ReturnCompletion(realm.intrinsics.undefined, realm.currentLocation);
            }
          }
          ...
          if (!(abruptCompletion instanceof _completions.JoinedAbruptCompletions)) return abruptCompletion;
