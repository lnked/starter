...
function OrdinaryGet(realm, O, P, Receiver, dataOnly) {
  ...
  let joinedEffects = _singletons.Join.joinEffects(realm, joinCondition, new _realm.Effects(result1, generator1, modifiedBindings1, modifiedProperties1, createdObjects1), new _realm.Effects(result2, generator2, modifiedBindings2, modifiedProperties2, createdObjects2));
...
function GetFromArrayWithWidenedNumericProperty(realm, arr, P) {
  ...
  if (typeof P === "string") {
    ...
    if (P === "length") {
      type = _index.NumberValue;
    }
  }
  let prop = typeof P === "string" ? new _index.StringValue(realm, P) : P;
  return _index.AbstractValue.createTemporalFromBuildFunction(realm, type, [arr, prop], ([o, p]) => t.memberExpression(o, p, true));
}
