...
class ObjectValue extends _index2.ConcreteValue {
  ...
  $GetPartial(P, Receiver) {
    ...
    if (!this.isSimpleObject()) {
      if (this.$Realm.isInPureScope()) {
        ...
        return _index2.AbstractValue.createTemporalFromBuildFunction(this.$Realm, _index2.Value, [Receiver, P], ([o, p]) => t.memberExpression(o, p, true));
      } else {
    ...
    if (this.isPartialObject()) {
      if (isWidenedValue(P)) {
        ...
        return _index2.AbstractValue.createTemporalFromBuildFunction(this.$Realm, _index2.Value, [this, P], ([o, p]) => t.memberExpression(o, p, true));
      }
      result = _index2.AbstractValue.createFromType(this.$Realm, _index2.Value, "sentinel member expression", [this, P]);
    } else {
      result = _index2.AbstractValue.createTemporalFromBuildFunction(this.$Realm, _index2.Value, [this, P], ([o, p]) => t.memberExpression(o, p, true));
    }
  ...
  specializeJoin(absVal, propName) {
    if (absVal.kind === "widened property") {
      ...
      return _index2.AbstractValue.createTemporalFromBuildFunction(this.$Realm, absVal.getType(), [ob, propName], ([o, p]) => {
    ...
    if (arg2 instanceof _index2.AbstractValue) {
      if (arg2.kind === "template for prototype member expression") {
        let ob = arg2.args[0];
        arg2 = _index2.AbstractValue.createTemporalFromBuildFunction(this.$Realm, absVal.getType(), [ob, propName], ([o, p]) => t.memberExpression(o, p, true));
  ...
  $SetPartial(P, V, Receiver) {
    ...
    if (!this.isSimpleObject()) {
      if (this.$Realm.isInPureScope()) {
        ...
        this.$Realm.evaluateWithPossibleThrowCompletion(() => {
          ...
          generator.emitStatement([Receiver, P, V], ([objectNode, keyNode, valueNode]) => t.expressionStatement(t.assignmentExpression("=", t.memberExpression(objectNode, keyNode, true), valueNode)));
    ...
    if (desc === undefined) {
      ...
      if (!(V instanceof _index2.UndefinedValue) && !isWidenedValue(P)) {
        ...
        newVal = _singletons.Join.joinValuesAsConditional(this.$Realm, cond, V, sentinel);
      }
      prop.descriptor = {
        writable: true,
        enumerable: true,
